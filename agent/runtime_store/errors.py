...
class StoreErrorCode(str, Enum):
    ...
    INTERRUPTION_REQUEST_CONFLICT = "INTERRUPTION_REQUEST_CONFLICT"
    INTERRUPTION_INTENT_NOT_FOUND = "INTERRUPTION_INTENT_NOT_FOUND"
    INTERRUPTION_PHASE_CONFLICT = "INTERRUPTION_PHASE_CONFLICT"
    INTERRUPTION_INJECTED_FAILURE = "INTERRUPTION_INJECTED_FAILURE"
    RUN_ALREADY_CANCELLING = "RUN_ALREADY_CANCELLING"
    RUN_ALREADY_CANCELLED = "RUN_ALREADY_CANCELLED"
    RUN_ALREADY_TIMED_OUT = "RUN_ALREADY_TIMED_OUT"

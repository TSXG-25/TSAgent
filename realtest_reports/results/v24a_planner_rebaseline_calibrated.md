...
- Source raw report: `realtest_reports/results/v24a_planner_rebaseline.json`
...
| Cases submitted | 46 |
| Evaluable cases | 44 |
| Capability pass | 20/44 (45.5%) |
| Raw case pass | 20/46 (43.5%) |
| Schema validity | 90.9% |
| Dependency validity | 90.9% |
| Executable plan rate | 45.5% |
| Missing task rate | 31.8% |
| Overplanning rate | 65.9% |
| Clarification accuracy | 90.9% |
| Unnecessary planning rate | 50.0% |
| Average / P95 tasks | 2.70 / 6 |
...
| P-CAP:UNDER_PLAN | 20 |
| P-PROV:INTERNAL | 1 |
| P-UNCERTAINTY:FALSE_ABSTENTION | 1 |
...
| PA022 | plan | NOT_CALLED | ❌ | 0 | 0ms | P-UNCERTAINTY:FALSE_ABSTENTION |
